...
function nikhar_spa_salon_setup() {	
	...
	load_theme_textdomain( 'nikhar-spa-salon', get_template_directory() . '/languages' );
	...
	global $pagenow;
		...
		add_action( 'admin_notices', 'nikhar_spa_salon_activation_notice' );
	}
}
add_action( 'after_setup_theme', 'nikhar_spa_salon_setup' );

// Notice after Theme Activation
function nikhar_spa_salon_activation_notice() {
	echo '<div class="notice notice-success is-dismissible start-notice">';
		echo '<h3>'. esc_html__( 'Welcome to Luzuk!!', 'nikhar-spa-salon' ) .'</h3>';
		echo '<p>'. esc_html__( 'Thank you for choosing Nikhar Spa Salon theme. It will be our pleasure to have you on our Welcome page to serve you better.', 'nikhar-spa-salon' ) .'</p>';
		echo '<p><a href="'. esc_url( admin_url( 'themes.php?page=nikhar_spa_salon_guide' ) ) .'" class="button button-primary">'. esc_html__( 'GET STARTED', 'nikhar-spa-salon' ) .'</a></p>';
	echo '</div>';
}
...
function nikhar_spa_salon_scripts() {
	...
	wp_add_inline_style( 'nikhar-spa-salon-basic-style',$nikhar_spa_salon_custom_style );
...
function nikhar_spa_salon_sanitize_float( $input ) {
    return filter_var($input, FILTER_SANITIZE_NUMBER_FLOAT, FILTER_FLAG_ALLOW_FRACTION);
}

//footer Link
define('NIKHAR_SPA_SALON_LIVE_DEMO',__('https://www.luzukdemo.com/demo/nikhar-spa-salon/','nikhar-spa-salon'));
define('NIKHAR_SPA_SALON_PRO_DOCS',__('https://www.luzukdemo.com/docs/nikhar-spa-salon/','nikhar-spa-salon'));
define('NIKHAR_SPA_SALON_BUY_NOW',__('https://www.luzuk.com/product/spa-wordpress-theme/','nikhar-spa-salon'));
define('NIKHAR_SPA_SALON_SUPPORT',__('https://wordpress.org/support/theme/nikhar-spa-salon/','nikhar-spa-salon'));
define('NIKHAR_SPA_SALON_CREDIT',__('https://www.luzuk.com/themes/free-spa-wordpress-theme/','nikhar-spa-salon'));
...
function nikhar_spa_salon_sanitize_checkbox( $input ) {
	return ( ( isset( $input ) && true == $input ) ? true : false );
}

function nikhar_spa_salon_sanitize_phone_number( $phone ) {
