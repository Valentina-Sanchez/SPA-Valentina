...
<?php if( get_theme_mod('nikhar_spa_salon_slider_hide_show',false) != false){ ?>	
	<section id="slider">
	  	<div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel"> 
		    <?php $nikhar_spa_salon_slider_pages = array();
		      	for ( $count = 1; $count <= 4; $count++ ) {
			        $mod = intval( get_theme_mod( 'nikhar_spa_salon_slider' . $count ));
			        if ( 'page-none-selected' != $mod ) {
			          	$nikhar_spa_salon_slider_pages[] = $mod;
			        }
		      	}
		      	if( !empty($nikhar_spa_salon_slider_pages) ) :
		        $args = array(
		          	'post_type' => 'page',
		          	'post__in' => $nikhar_spa_salon_slider_pages,
		          	'orderby' => 'post__in'
		        );
		...
		<div class="container">		
			<div class="service-box">
				<div class="service-title">
					<?php if( get_theme_mod('nikhar_spa_salon_our_services_title') != ''){ ?>
			    		<h2><?php echo esc_html(get_theme_mod('nikhar_spa_salon_our_services_title','')); ?></h2>
	            ...
	            <div class="row">
		      		<?php
		      		$nikhar_spa_salon_catData1=  get_theme_mod('nikhar_spa_salon_category_setting');
          			if($nikhar_spa_salon_catData1){ 
		      			$page_query = new WP_Query(array( 'category_name' => esc_html($nikhar_spa_salon_catData1 ,'nikhar-spa-salon')));?>
