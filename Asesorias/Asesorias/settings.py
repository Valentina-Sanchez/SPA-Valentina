"""
Django settings for Asesorias project.
...
SECRET_KEY = 'django-insecure-a7d0$9xx82r9^7j7b4rt(pn19i*h(trty9rs^)_-72iv30e6$k'
...
WSGI_APPLICATION = 'Asesorias.wsgi.application'
